...
class LogisticRegression(nn.Module):
    def __init__(self, input_dim):
        ...
        # Only want 1 output, that preds either > 0.5 or less
...
def compute_metrics(model, X_val, y_val, batch_size=64):
    # No longer training
    model.eval()
...
def main():
    ...
    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")
    print("TRAINING AND EVALUATING LOGISTIC REGRESSION WITH K-FOLD CROSS-VALIDATION....")
    print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~")    
    k_folds = 5
    fold_metrics = []
    fold_losses = []
